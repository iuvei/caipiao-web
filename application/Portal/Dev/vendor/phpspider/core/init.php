...
function phpspider_send_telegram_message($message, $receiver = '') {
    if (constant('CONF_ENVIRONMENT') == 'formal') {
        return send_telegram_message($message, $receiver);
    }
    Logger::write('phpspiderCore', 'ignored_wechat_message', [$message, $receiver]);
    return 'ignored';
}
