        ...
        __setselectlogs: function () {
            ...
            if ($("s3").style.display != 'none') {
                ...
                for (var i = 1; i <= 4; i++) {
                    ...
                    if (value !== '') {
                        ztemp += '' + $$(textElement[i - 1]).text() + '=' + baseTarget + value + baseTarget1 + '';
                    }
                }
            ...
            if ($("s6").style.display != 'none') {
                ...
                if (value) {
                    ...
                    temp = '不定位和分:' + temp + baseTarget + value + baseTarget1;
                }
                str += temp;
                temp = '';
            }
            ...
            if ($("zfw1").style.display != 'none' && this.__classid == 3) {
                ...
                if (temp || temp1) {
                    str += '值范围=' + baseTarget + temp + baseTarget1 + '至' + baseTarget + temp1 + baseTarget1;
                }
                temp = '';
                temp1 = '';
            }
            ...
            if (this.__classid <= 3) {
                ...
                if (element.style.display != 'none') {
                    if (element.value) {
                        str += '全转:' + baseTarget + element.value + baseTarget1;
                    }
                };
                element = $("__shangjiang");
                if (element.style.display != 'none') {
                    if (element.value) {
                        str += '上奖:' + baseTarget + element.value + baseTarget1;
                    }
                };
                element = $("__paichu");
                if (element.style.display != 'none') {
                    if (element.value) {
                        str += '排除:' + baseTarget + element.value + baseTarget1;
                    }
                };
            }
            //乘号位置
            ...
            if ($("han" + this.__classid).style.display != 'none') {
                ...
                if (value) {
                    temp += '含=' + baseTarget + value + baseTarget1;
                }
                value = $("__fushi_" + this.__classid).value;
                if (value) {
                    temp += '复式=' + baseTarget + value + baseTarget1;
                }
                // if (temp) {
                //     temp = '复式:' + temp;
                // }
            ...
            if ($("s12").style.display != 'none') {
                ...
                var temp1='';
                for (var i = 1; i <= 4; i++) {
                    if($("__peishu_" + i).value){
                        temp1 += $("__peishu_" + i).value + ",";
                    }
                }
                if(temp1){
                if (this.__classid > 3) {
        ...
        this.submit = function () {
            ...
            if (1) {//confirm(confirmTip)
                ...
                //}
                    ...
                    var Bzxx=__ss.__curType+":"+__ss.__logString;
                    console.log(Bzxx);
